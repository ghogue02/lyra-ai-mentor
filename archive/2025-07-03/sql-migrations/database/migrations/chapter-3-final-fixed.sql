-- Chapter 3: Sofia Martinez - Communication & Storytelling (FINAL FIXED VERSION)
...
Same old stories, same disappointing results, Sofia mutters while scrolling through their donor database. Open rates: 12%. Click-through rates: 2%. Donations: barely enough to cover postage. Meanwhile, other nonprofits seem to effortlessly capture hearts and wallets with their communications.

Sofia knows their work saving abandoned animals is incredible. Last month alone they rescued 47 dogs from a puppy mill operation. So why cannot she make people care enough to give?', '{}', 10),
...
Her emails, by contrast, read like annual reports: Q3 Rescue Statistics Update and Monthly Operational Overview. The data is impressive: 847 animals saved this year, 94% adoption rate, 12 community partnerships. But it feels cold and impersonal.

I am a communications professional, Sofia thinks. I have a Masters degree in Nonprofit Management. Why am I failing at the one thing I am supposed to be good at? She is missing something fundamental about how great stories actually work.', '{}', 20),
...
AI for writing? Sofia is skeptical but desperate. She uploads one of her failed fundraising emails and asks the AI to analyze what is missing. The response surprises her: This email focuses on statistics rather than emotional connection. Readers need to feel the impact, not just understand it.

The AI suggests rewriting her opening: Instead of We rescued 47 dogs this month, try Daisy was found shivering in a cardboard box, her ribs visible through matted fur. Today, she is playing fetch in her forever home - one of 47 happy endings we created together this month.

Sofia feels a spark of hope. Maybe there is a way to make her communications as compelling as their mission.', '{}', 30);

-- Lesson 11 Interactive Elements
...
Tell me about Charlie, Sofia types. The AI asks follow-up questions: What was his emotional state when he arrived? What challenges did he face? What was his breakthrough moment? Sofia realizes she has never thought about their rescues as individual stories with emotional arcs.

As she describes Charlie''s journey from confused and grieving to finding peace with a retired teacher who needed companionship as much as he did, the AI helps her craft something beautiful: Charlie did not understand why his world disappeared overnight. Thirteen years of morning walks and evening treats, gone. When he arrived at Riverside Animal Rescue, his eyes held the heartbreak only seniors understand.
...
But how do I scale this? Sofia wonders. I cannot write a novel for every animal. The AI explains that powerful stories do not need to be long. They need to be specific. Instead of we help many animals, focus on one compelling case that represents the broader impact.
...
The difference is profound. Sofia realizes she has been hiding behind professionalism when donors actually want authenticity. People give to causes that move them, not organizations that impress them.
...
Sofia feels something shift inside her. She is not just learning new writing techniques. She is rediscovering why she became a nonprofit communicator in the first place.', '{}', 30);

-- Lesson 12 Interactive Elements
INSERT INTO interactive_elements (lesson_id, type, title, content, configuration, order_index)
VALUES
...
But Sofia has a new strategy. Instead of leading with financial needs, she will tell the story of Luna, a pregnant German Shepherd who arrived three days ago with dangerous complications that require emergency C-section. Without the surgical equipment, Luna and her puppies will not survive.
...
The words flow differently now. Sofia is not just reporting medical expenses. She is sharing the story of life hanging in the balance and the equipment that makes miracles possible.', '{}', 10),
...
Sofia does not immediately ask for money. Instead, she shows the impact: Thanks to our backup equipment (purchased with funds from supporters like you), Luna delivered six healthy puppies at 4:17 AM. But this close call revealed a dangerous gap in our medical capabilities.
...
The ask comes naturally: Your $50 gift helps ensure we are always ready for the next Luna. Because when lives hang in the balance, maybe next time is not an option.', '{}', 20),
  ...
  (13, 'text_block', 'The Campaign Launch', 'Sofia hits send on her Luna campaign email to 2,847 subscribers at 9 AM on Tuesday. By noon, her phone will not stop buzzing. The campaign has already raised $3,200, more than their last three appeals combined.

The responses overwhelm her: I have been getting your emails for two years, but this is the first time I really understood what my donations do. Luna''s story brought me to tears. Please use my $100 where it is needed most. I am a vet tech and know exactly how terrifying equipment failures are during emergency surgery. Here is $200.

But the most meaningful response comes from Margaret, Charlie''s adopter: Sofia, I do not know how you did it, but your email made me feel like I was right there in the surgical suite. I am increasing my monthly giving because now I understand. You are not just rescuing animals, you are rescuing families.

By Friday, the campaign has exceeded its goal by 40%. Sofia realizes she has not just learned to write better emails. She has discovered how to help donors see their role in the mission.', '{}', 30);

-- Lesson 13 Interactive Elements
INSERT INTO interactive_elements (lesson_id, type, title, content, configuration, order_index)
VALUES
...
The AI does not write our stories, Sofia explains to other nonprofit communications directors who visit to learn her methods. It helps us recognize the stories that are already there. Every animal we rescue has a narrative arc. We just needed to learn how to see it and share it.
...
Her latest email about Max, a pit bull who overcame severe anxiety to become a therapy dog for trauma survivors, raised $23,000 in one week for their behavioral rehabilitation program.', '{}', 10),
  ...
  (14, 'text_block', 'Teaching Others', 'Sofia''s success has not gone unnoticed. The Regional Nonprofit Coalition asks her to lead a workshop on AI-Enhanced Storytelling for Maximum Impact. As she prepares her presentation, Sofia reflects on her transformation journey.
...
The secret, Sofia concludes, is not manipulation. It is authenticity. AI helped me find my authentic voice as a storyteller, not replace it.', '{}', 20),
...
Sofia realizes her next challenge: scaling her storytelling expertise beyond animal rescue. Can the narrative techniques that work for Luna and Max also work for youth programs, environmental initiatives, or economic development? She is about to find out.
...
-- Lesson 14 Interactive Elements
INSERT INTO interactive_elements (lesson_id, type, title, content, configuration, order_index)
VALUES
