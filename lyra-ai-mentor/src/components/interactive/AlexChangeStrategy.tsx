        ...
        return (
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              <ExportButton
                data={(): ExportData => ({
                  title: `Change Strategy - ${new Date().toLocaleDateString()}`,
                  content: enhancedOutput || userInput,
                  metadata: {
                    createdAt: new Date().toISOString(),
                    author: 'Alex Johnson',
                    tags: ['strategy', 'change-management', 'leadership', 'transformation'],
                    strategyType: 'organizational-change'
                  },
                  sections: [
                    {
                ...
                className="flex-1"
                characterName="Alex"
                suggestUseIn={['Rachel Workflows', 'Sofia Communications', 'Training Programs']}
              />
              <Button 
            ...
            <UseInSuggestions
              content={{
                strategy: enhancedOutput,
                originalApproach: userInput,
                type: 'change-management'
              }}
              contentType="strategy"
              fromCharacter="Alex"
              componentType="alex-change"
              className="mt-4"
            />
          </div>
        );
