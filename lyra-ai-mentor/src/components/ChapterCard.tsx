  ...
  return (
    <Card className={cn(
      ...
      <CardHeader className="pb-4 flex-shrink-0">
        ...
        <CardTitle className="text-lg font-semibold mt-4 h-14 overflow-hidden line-clamp-2">
          Chapter {chapter.id}: {chapter.title}
        </CardTitle>
        <CardDescription className="text-gray-600 text-sm h-16 overflow-hidden line-clamp-3">
          {chapter.description}
        </CardDescription>
      </CardHeader>
