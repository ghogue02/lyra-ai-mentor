-- Refine Chapter 2: Reduce to 3-4 components per lesson with better story integration
-- Clean up existing components and add refined ones
...
VALUES
  -- Maya's parent email challenge - right after she discovers AI can help
  (5, 'ai_email_composer', 'Help Maya Write the Parent Response', 
   'Maya just received this email from a concerned parent: "I''m worried about the new pickup procedures. My work schedule is unpredictable, and I''m afraid I won''t be able to get Marcus on time. Can you help me understand the options?"
...
Maya wants to respond with empathy while clearly explaining the policy. Help her craft the perfect response.', 
  ...
  -- Maya's board chair challenge - her biggest test after learning about difficult conversations
  (5, 'difficult_conversation_helper', 'Maya''s Board Chair Challenge', 
   'Now Maya faces her biggest test. The board chair just emailed: "Maya, I need the Q3 budget variance report by tomorrow for the executive committee meeting. I know it''s short notice, but the committee specifically requested it."

Maya doesn''t have the data compiled yet, and creating the report will take 6+ hours. Help her decline gracefully while maintaining the relationship.', 
   '{"scenario": "impossible_deadline", "character": "Maya Rodriguez", "relationship": "board_chair", "stakes": "professional_credibility"}', 70),

  -- Maya's reflection and mentoring - at the end of her transformation
  (5, 'lyra_chat', 'Maya''s Coffee Chat: What''s Next?', 
   'Maya has mastered AI-powered email communication and wants to share her excitement with you. She''s curious about your email challenges and eager to help you apply what she''s learned.
...
INSERT INTO interactive_elements (lesson_id, type, title, content, configuration, order_index)
VALUES
  -- James's grant proposal crisis - right when he's stuck at 10 PM
  (6, 'document_generator', 'Help James Complete His Grant Proposal', 
   'It''s 10 PM and James is stuck on the "Project Impact" section for the Morrison Foundation grant. He needs to explain why butterfly habitat restoration matters for urban ecosystems, but foundation officers might not understand the science.
...
Help James generate an impact section that balances scientific credibility with emotional appeal.', 
  ...
  -- James polishes his rough draft - after getting unstuck
...
Help James transform this into something that would make foundation officers excited to fund the project.', 
  ...
  -- James celebrates and mentors others - final component
...
-- Connect Maya and James storylines in content
