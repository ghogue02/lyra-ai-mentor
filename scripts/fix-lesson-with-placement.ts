...
async function fixLessonWithPlacement() {
  const filePath = 'src/components/lesson/LessonWithPlacement.tsx'
...
export const LessonWithPlacement: React.FC<LessonWithPlacementProps> = ({ chapterId, lessonId }) => {
  ...
  await fs.writeFile(filePath, correctContent)
  console.log('✅ Fixed LessonWithPlacement.tsx')
}

fixLessonWithPlacement().catch(console.error)