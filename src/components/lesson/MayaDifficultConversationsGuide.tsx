      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">1. Maya's Communication Crisis</h3>
            <p className="text-gray-600">When tough conversations went wrong</p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <Lightbulb className="w-8 h-8 text-purple-600" />
            </div>
            <h3 className="text-lg font-semibold mb-2">2. Discover Empathy Framework</h3>
            <p className="text-gray-600">Learn authentic connection principles</p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <CheckCircle className="w-8 h-8 text-green-600" />
            </div>
            <h3 className="text-lg font-semibold mb-2">3. Maya's Trust Building</h3>
            <p className="text-gray-600">Transform conflicts into connections</p>
          </div>
        </div>
