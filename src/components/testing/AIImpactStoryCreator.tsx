  ...
  return (
    <div className="space-y-4">
      <div className="text-center">
        <h3 className="font-medium text-gray-800 mb-2">AI Impact Story Creator</h3>
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <Textarea
            placeholder="Describe the person or group helped (anonymized)..."
        ...
        <div>
          ...
          <Textarea
            placeholder="What changed? Include specific metrics and improvements..."
            value={outcomes}
        ...
        <div>
          ...
          <Textarea
            placeholder="Challenges overcome, community impact, future goals..."
            value={context}
