...
const Component = MayaGrantProposal;
...
// Additional tests specific to MayaGrantProposal
describe('MayaGrantProposal Specific Tests', () => {
  it('should render MayaGrantProposal component without errors', () => {
    const element = {
      id: 1,
      type: 'document_generator',
      title: 'MayaGrantProposal Test',
      content: 'Test content for MayaGrantProposal',
      configuration: {},
      order_index: 1,
    };
  ...
  it('should handle component-specific configuration', () => {
    const element = {
      id: 1,
      type: 'document_generator',
      title: 'MayaGrantProposal Configuration Test',
  ...
  it('should handle edge cases and null configurations', () => {
    ...
    edgeCases.forEach((config, index) => {
      const element = {
        id: index + 1,
        type: 'document_generator',
        title: 'MayaGrantProposal Edge Case Test',
  ...
  it('should handle user interactions properly', () => {
    const element = {
      id: 1,
      type: 'document_generator',
      title: 'MayaGrantProposal Interaction Test',
