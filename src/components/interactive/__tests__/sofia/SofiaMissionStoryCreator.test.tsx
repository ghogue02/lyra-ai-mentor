...
const Component = SofiaMissionStoryCreator;
...
// Additional tests specific to SofiaMissionStoryCreator
describe('SofiaMissionStoryCreator Specific Tests', () => {
  it('should render SofiaMissionStoryCreator component without errors', () => {
    const element = {
      id: 1,
      type: 'ai_content_generator',
      title: 'SofiaMissionStoryCreator Test',
      content: 'Test content for SofiaMissionStoryCreator',
      configuration: {},
      order_index: 1,
    };
  ...
  it('should handle component-specific configuration', () => {
    const element = {
      id: 1,
      type: 'ai_content_generator',
      title: 'SofiaMissionStoryCreator Configuration Test',
  ...
  it('should handle edge cases and null configurations', () => {
    ...
    edgeCases.forEach((config, index) => {
      const element = {
        id: index + 1,
        type: 'ai_content_generator',
        title: 'SofiaMissionStoryCreator Edge Case Test',
  ...
  it('should handle user interactions properly', () => {
    const element = {
      id: 1,
      type: 'ai_content_generator',
      title: 'SofiaMissionStoryCreator Interaction Test',
