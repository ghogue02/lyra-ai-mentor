...
const Component = SofiaVoiceDiscovery;
...
// Additional tests specific to SofiaVoiceDiscovery
describe('SofiaVoiceDiscovery Specific Tests', () => {
  it('should render SofiaVoiceDiscovery component without errors', () => {
    const element = {
      id: 1,
      type: 'document_improver',
      title: 'SofiaVoiceDiscovery Test',
      content: 'Test content for SofiaVoiceDiscovery',
      configuration: {},
      order_index: 1,
    };
  ...
  it('should handle component-specific configuration', () => {
    const element = {
      id: 1,
      type: 'document_improver',
      title: 'SofiaVoiceDiscovery Configuration Test',
  ...
  it('should handle edge cases and null configurations', () => {
    ...
    edgeCases.forEach((config, index) => {
      const element = {
        id: index + 1,
        type: 'document_improver',
        title: 'SofiaVoiceDiscovery Edge Case Test',
  ...
  it('should handle user interactions properly', () => {
    const element = {
      id: 1,
      type: 'document_improver',
      title: 'SofiaVoiceDiscovery Interaction Test',
