        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-xl font-bold mb-2">Find Your Communication Style</h2>
              <p className="text-gray-600">Which voice feels most authentic to Sofia?</p>
            </div>
              ...
              {voiceProfiles.map((voice) => (
                <Card 
                  ...
                  className={`cursor-pointer transition-all ${
                    voice.selected ? 'ring-2 ring-purple-500 bg-purple-50' : 'hover:shadow-md'
                  }`}
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <h3 className="font-bold text-purple-700">{voice.label}</h3>
                        {voice.selected && <span className="text-purple-600">✓ Selected</span>}
                      </div>
                      
                      <p className="text-gray-600 text-sm">{voice.description}</p>
                      
                      <div className="flex flex-wrap gap-2">
                        {voice.toneWords.map((word, idx) => (
